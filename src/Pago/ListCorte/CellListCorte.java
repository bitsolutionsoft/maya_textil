...
public class CellListCorte  extends ListCell<Corte> {
    AlertDialog alertDialog=new AlertDialog();
    private Node graphic;
    private RowListCorte rowCorte;
    // el constructor donde llamamos el el rowproducto
    public CellListCorte(){
        FXMLLoader loader=new FXMLLoader(getClass().getResource("/Pago/ListCorte/RowListCorte.fxml"));
        try {
            graphic=loader.load();
        }catch (IOException e){
            e.printStackTrace();
        ...
        rowCorte.btnEliminar.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                if (alertDialog.alertConfirm("Corte", "¿Esta seguro de desactivar este corte?")){
                    ...
                    ListCorte corteController=new ListCorte();
