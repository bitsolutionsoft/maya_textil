...
public class EstiloController  implements Initializable {
    ...
    public ListView<Estilo> listViewEstilo;
...
*  private void iniciarTabla(){
      //  tblEstilo.setEditable(true);
        ...
        cellCodigo.setCellValueFactory(new PropertyValueFactory<>("codigo"));
        cellNombre.setCellValueFactory(new PropertyValueFactory<>("nombre"));
        cellEstado.setCellValueFactory(new PropertyValueFactory<>("estado"));
         ...
         final TableCell<Estilo, String> cell=new TableCell<>(){
             ...
             public void updateItem(String item, boolean empty){
                if(empty){
                    ...
                    ImageView editButton=new ImageView("/Img/edit.png");
                    editButton.setFitHeight(sizeIcon);
                    editButton.setFitWidth(sizeIcon);
                    editButton.setStyle(estilobtn);

                    ImageView deleteButton=new ImageView("/Img/delete.png");
                    deleteButton.setFitHeight(sizeIcon);
                    deleteButton.setFitWidth(sizeIcon);
                    deleteButton.setStyle(estilobtn);
